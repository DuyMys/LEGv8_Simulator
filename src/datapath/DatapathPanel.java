...
public class DatapathPanel extends JPanel implements ExecutionHistoryListener {
    ...
    private static final Color CONTROL_SIGNAL_BUS_COLOR = new Color(186, 72, 127); //  control signals
    ...
    private List<ComponentInfo> initializeComponents() {
        ...
        comps.add(new ComponentInfo("DATA_MEMORY", baseX + 790 + spacingX, baseY + 150, 120, 150, 
                                    "Data\nMemory", null, null));
        ...
        comps.add(new ComponentInfo("ADD_1", baseX + 120, baseY - 210, 70, 80, 
                                    "Add", null, null));
        // ADD_2
        dim = imageDimensions.get(ComponentID.ADD_2);
        comps.add(new ComponentInfo("ADD_2", baseX + 550 + spacingX, baseY - 207, 90,90, 
                                    "Add", null, null));
        // SHIFT_LEFT_2
        dim = imageDimensions.get(ComponentID.SHIFT_LEFT_2);
        comps.add(new ComponentInfo("SHIFT_LEFT_2", baseX + 472 + spacingX, baseY - 175, 40, 50, 
                                    "Shift\nLeft 2", null, null));
        // MUX_PCSRC
        dim = imageDimensions.get(ComponentID.MUX_PCSRC);
        comps.add(new ComponentInfo("MUX_PCSRC", baseX + 900 + spacingX, baseY - 230, 30, 80, 
                                    "M\nU\nX", null, null));
        // ALU Control
        ...
        comps.add(new ComponentInfo("CONTROL_UNIT", baseX + 300 + spacingX, baseY - 140, 140, 220, 
                                    "Control\nUnit", null, null));
        // AND Gate
        dim = imageDimensions.get(ComponentID.AND_GATE);
        comps.add(new ComponentInfo("AND_GATE", baseX + 755, baseY + 60, 45, 30, 
                                    "", null, null));
        // OR Gate
        dim = imageDimensions.get(ComponentID.OR_GATE);
        comps.add(new ComponentInfo("OR_GATE", baseX + 850 + spacingX, baseY - 85, 45, 30, 
                                    "", null, null));
        // Add_4
        dim = imageDimensions.get(ComponentID.ADD_4);
        comps.add(new ComponentInfo("ADD_4", baseX + 80, baseY - 160, 20, 20, 
                                    "4", null, null));
        // AND2 Gate
        dim = imageDimensions.get(ComponentID.AND2_GATE);
        comps.add(new ComponentInfo("AND2_GATE", baseX + 780 + spacingX, baseY + 60, 45, 30, 
                                    "", null, null));
        // Flag
        dim = imageDimensions.get(ComponentID.NFLAG);
        comps.add(new ComponentInfo("NFLAG", baseX + 600 + spacingX, baseY + 70, 20, 20, 
                                    "N", null, null));
        dim = imageDimensions.get(ComponentID.ZFLAG);
        comps.add(new ComponentInfo("ZFLAG", baseX + 600 + spacingX + 20, baseY + 70, 20, 20, 
                                    "Z", null, null));
        dim = imageDimensions.get(ComponentID.CFLAG);
        comps.add(new ComponentInfo("CFLAG", baseX + 600 + spacingX + 40, baseY + 70, 20, 20, 
                                    "C", null, null));
        dim = imageDimensions.get(ComponentID.VFLAG);
        comps.add(new ComponentInfo("VFLAG", baseX + 600 + spacingX + 60, baseY + 70, 20, 20, 
                                    "V", null, null));
        return comps;
    }
    ...
    private List<BusInfo> initializeBuses() {
        ...
        busDrawArrow.put(BusID.CONTROL_FLAG_BRANCH_TO_AND1_GATE, false);
        busDrawArrow.put(BusID.CONTROL_ZERO_BRANCH_TO_AND2_GATE, false);
        busDrawArrow.put(BusID.CONTROL_UNCOND_TO_OR_GATE, false);
        busDrawArrow.put(BusID.CONTROL_REG2LOC_TO_MUX_reg2loc, false);
        busDrawArrow.put(BusID.ALU_TO_AND2_GATE, false);
        ...
        busDrawArrow.put(BusID.CONTROL_FLAGWRITE_TO_REGISTERS, false);
        busDrawArrow.put(BusID.FLAG_TO_AND_GATE, false);
        busDrawArrow.put(BusID.AND2_GATE_TO_OR_GATE, false);
        busDrawArrow.put(BusID.INSTRUCTION_MEMORY_, false);
        ...
        // ALU paths
        pathPoints.put(BusID.ALU_TO_AND2_GATE, 
            Arrays.asList(
                new Point(compBounds.get("ALU").x + compBounds.get("ALU").width, compBounds.get("ALU").y + 60),
                new Point(compBounds.get("ALU").x + compBounds.get("ALU").width + 70, compBounds.get("ALU").y + 60),
                new Point(compBounds.get("ALU").x + compBounds.get("ALU").width + 70, compBounds.get("AND2_GATE").y + 20),
                new Point(compBounds.get("AND2_GATE").x + 10, compBounds.get("AND2_GATE").y + 20)
            ));
        ...
        pathPoints.put(BusID.ALU_TO_MUX_memtoreg_RESULT, Arrays.asList(
            ...
            new Point(compBounds.get("MUX_memtoreg").x - 20, compBounds.get("MUX_memtoreg").y + compBounds.get("MUX_memtoreg").height - 20), 
            new Point(compBounds.get("MUX_memtoreg").x, compBounds.get("MUX_memtoreg").y + compBounds.get("MUX_memtoreg").height - 20) 
        ));
        pathPoints.put(BusID.ALU_TO_FLAGS, Arrays.asList(
            new Point(compBounds.get("ALU").x + compBounds.get("ALU").width / 2 + 10, compBounds.get("ALU").y + 15),
            new Point(compBounds.get("ALU").x + compBounds.get("ALU").width / 2 + 10, compBounds.get("NFLAG").y + compBounds.get("NFLAG").height) 
        ));
        ...
        pathPoints.put(BusID.AND_GATE_TO_OR_GATE, Arrays.asList(
            ...
            new Point(compBounds.get("AND_GATE").x + compBounds.get("AND_GATE").width + 10, compBounds.get("AND_GATE").y + compBounds.get("AND_GATE").height / 2),
            new Point(compBounds.get("AND_GATE").x + compBounds.get("AND_GATE").width + 10, compBounds.get("OR_GATE").y + compBounds.get("OR_GATE").height - 12),
            new Point(compBounds.get("OR_GATE").x + 10, compBounds.get("OR_GATE").y + compBounds.get("OR_GATE").height - 12)
        ));
        pathPoints.put(BusID.AND2_GATE_TO_OR_GATE, Arrays.asList(
            new Point(compBounds.get("AND2_GATE").x + compBounds.get("AND2_GATE").width - 10, compBounds.get("AND2_GATE").y + compBounds.get("AND2_GATE").height / 2),
            new Point(compBounds.get("AND2_GATE").x + compBounds.get("AND2_GATE").width + 10, compBounds.get("AND2_GATE").y + compBounds.get("AND2_GATE").height / 2),
            new Point(compBounds.get("AND2_GATE").x + compBounds.get("AND2_GATE").width + 10, compBounds.get("OR_GATE").y + compBounds.get("OR_GATE").height - 5),
            new Point(compBounds.get("OR_GATE").x + 10, compBounds.get("OR_GATE").y + compBounds.get("OR_GATE").height - 5)
        ));
        ...
        pathPoints.put(BusID.FLAG_TO_AND_GATE, Arrays.asList(
            new Point(compBounds.get("VFLAG").x + compBounds.get("VFLAG").width, compBounds.get("VFLAG").y + compBounds.get("VFLAG").height - 10),
            new Point(compBounds.get("AND_GATE").x + 10, compBounds.get("VFLAG").y + compBounds.get("VFLAG").height - 10)
        ));
        // Sign Extend paths
        ...
        pathPoints.put(BusID.ALU_CONTROL_TO_ALU, Arrays.asList(
            ...
            new Point(compBounds.get("ALU_CONTROL").x + compBounds.get("ALU_CONTROL").width / 2, compBounds.get("ALU").y + compBounds.get("ALU").height - 10)
        ));
        // Control Unit paths
        ...
        pathPoints.put(BusID.CONTROL_FLAG_BRANCH_TO_AND1_GATE, Arrays.asList(
            new Point(compBounds.get("CONTROL_UNIT").x + compBounds.get("CONTROL_UNIT").width, compBounds.get("CONTROL_UNIT").y + 50),
            new Point(compBounds.get("AND_GATE").x - 10, compBounds.get("CONTROL_UNIT").y + 50),
            new Point(compBounds.get("AND_GATE").x - 10, compBounds.get("AND_GATE").y + 10),
            new Point(compBounds.get("AND_GATE").x + 10, compBounds.get("AND_GATE").y + 10)
        ));
        pathPoints.put(BusID.CONTROL_ZERO_BRANCH_TO_AND2_GATE, Arrays.asList(
            new Point(compBounds.get("CONTROL_UNIT").x + compBounds.get("CONTROL_UNIT").width, compBounds.get("CONTROL_UNIT").y + 70),
            new Point(compBounds.get("AND2_GATE").x - 10, compBounds.get("CONTROL_UNIT").y + 70),
            new Point(compBounds.get("AND2_GATE").x - 10, compBounds.get("AND2_GATE").y + 10),
            new Point(compBounds.get("AND2_GATE").x + 10, compBounds.get("AND2_GATE").y + 10)
        ));
        pathPoints.put(BusID.CONTROL_MEMREAD_TO_DATA_MEMORY, Arrays.asList(
            ...
            new Point(compBounds.get("MUX_memtoreg").x + compBounds.get("MUX_memtoreg").width + 20, compBounds.get("CONTROL_UNIT").y + 90),
        ...
        pathPoints.put(BusID.CONTROL_MEMTOREG_TO_MUX_memtoreg, Arrays.asList(
            ...
            new Point(compBounds.get("MUX_memtoreg").x + compBounds.get("MUX_memtoreg").width / 2, compBounds.get("CONTROL_UNIT").y + 110),
        ...
        pathPoints.put(BusID.CONTROL_FLAGWRITE_TO_REGISTERS, Arrays.asList(
            new Point(compBounds.get("CONTROL_UNIT").x + compBounds.get("CONTROL_UNIT").width, compBounds.get("CONTROL_UNIT").y + 150),
            new Point(compBounds.get("ZFLAG").x + compBounds.get("ZFLAG").width, compBounds.get("CONTROL_UNIT").y + 150),
            new Point(compBounds.get("ZFLAG").x + compBounds.get("ZFLAG").width, compBounds.get("ZFLAG").y) 
        ));
        pathPoints.put(BusID.CONTROL_ALUSRC_TO_MUX_ALUsrc, Arrays.asList(
            ...
            new Point(compBounds.get("MUX_ALUsrc").x + compBounds.get("MUX_ALUsrc").width / 2, compBounds.get("CONTROL_UNIT").y + 170),
        ...
        pathPoints.put(BusID.CONTROL_ALUOP_TO_ALU_CONTROL, Arrays.asList(
            new Point(compBounds.get("CONTROL_UNIT").x + compBounds.get("CONTROL_UNIT").width, compBounds.get("CONTROL_UNIT").y + 190),
            new Point(compBounds.get("REGISTERS").x + compBounds.get("REGISTERS").width + 20, compBounds.get("CONTROL_UNIT").y + 190),
        ...
        pathPoints.put(BusID.CONTROL_REGWRITE_TO_REGISTERS, Arrays.asList(
            new Point(compBounds.get("CONTROL_UNIT").x + compBounds.get("CONTROL_UNIT").width, compBounds.get("CONTROL_UNIT").y + 210),
            new Point(compBounds.get("REGISTERS").x + compBounds.get("REGISTERS").width - 30, compBounds.get("CONTROL_UNIT").y + 210),
    ...
    private BusID mapPathToBusID(Datapath.Path path) {
        ...
        // ALU paths
                ...
                path.getDestination() == Datapath.Component.AND2_GATE) {
            return BusID.ALU_TO_AND2_GATE;
        }  
        else if (path.getSource() == Datapath.Component.ALU && 
                path.getDestination() == Datapath.Component.DATA_MEMORY && 
            ...
            return BusID.ALU_TO_MUX_memtoreg_RESULT;
                ...
                path.getDestination() == Datapath.Component.NFLAG) {
            return BusID.ALU_TO_FLAGS;
        }
        ...
        else if (path.getSource() == Datapath.Component.AND2_GATE && 
                   path.getDestination() == Datapath.Component.OR_GATE) {
            return BusID.AND2_GATE_TO_OR_GATE;
        }
        ...
        // Control Unit paths
            ...
            return BusID.CONTROL_UNCOND_TO_OR_GATE;
                   ...
                   path.getDestination() == Datapath.Component.AND2_GATE) {
            return BusID.CONTROL_ZERO_BRANCH_TO_AND2_GATE;
        }
        else if (path.getSource() == Datapath.Component.CONTROL_UNIT && 
                   path.getDestination() == Datapath.Component.DATA_MEMORY && 
            ...
            return BusID.CONTROL_MEMREAD_TO_DATA_MEMORY;
                   ...
                   path.getDestination() == Datapath.Component.NFLAG) {
            return BusID.CONTROL_FLAGWRITE_TO_REGISTERS;
        }
        else if (path.getSource() == Datapath.Component.CONTROL_UNIT && 
                   path.getDestination() == Datapath.Component.AND_GATE) {
            return BusID.CONTROL_FLAG_BRANCH_TO_AND1_GATE;
        }
        else if (path.getSource() == Datapath.Component.CONTROL_UNIT && 
                   path.getDestination() == Datapath.Component.MUX_memtoreg) {
        ...
        else if (path.getSource() == Datapath.Component.NFLAG && 
                   path.getDestination() == Datapath.Component.AND_GATE) {
            return BusID.FLAG_TO_AND_GATE;
        }
    ...
    public void setActiveComponentsAndBuses(List<String> activeComponents, List<String> activeBuses,
        ...
        setActiveComponentsAndBuses(activeComponents, activeBuses, busDataValues, null);
    }
    
    public void setActiveComponentsAndBuses(List<String> activeComponents, List<String> activeBuses,
                                            Map<String, String> busDataValues, String stepDescription) {
        // Update the current step description if provided
    ...
    /**
     * Checks if a bus is a control signal bus based on its ID.
     * @param busId The bus ID to check
     * @return true if this is a control signal bus, false otherwise
     */
    private boolean isControlSignalBus(BusID busId) {
        if (busId == null) return false;
        return busId.name().startsWith("CONTROL_");
    }
    ...
    private void drawBus(Graphics2D g2d, BusInfo busInfo) {
        ...
        Color lineColor;
        if (isBusHighlighted) {
            // Check if this is a control signal bus during the control signal generation step
            if (isControlSignalBus(id)) {
                lineColor = CONTROL_SIGNAL_BUS_COLOR;
            } else {
                lineColor = HIGHLIGHT_BUS_COLOR;
            }
        } else {
            lineColor = DEFAULT_BUS_COLOR;
        }
